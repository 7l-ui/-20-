...
extern int ltlc;
extern int target_speed2;
extern int target_speedy;
extern float target_zhijiao;
extern float duty_steer;
extern float target_angle_vel;
extern float target_angle;
extern float car_zero_angle;
extern float target_yaw_rate;
extern int tingche_flag;
//extern float long1_flag;
//extern float long2_flag;
