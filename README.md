# STC32G12K128 智能车控制工程

这是一个基于 STC32G12K128 和 Keil uVision 的智能车控制工程，代码包含电机控制、PID 控制、姿态角解算、循迹、数据采集和屏幕菜单等模块。
...
- `DAIMXA.uvopt`: Keil uVision 工程选项文件。
...
当前仓库未提交 Keil 编译输出、用户界面配置和本机临时文件，例如 `Objects/`、`Listings/`、`.uvgui.*` 和 `.vscode/`。
